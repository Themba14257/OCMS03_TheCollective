...
namespace OCMS03.Data
{
    ...
    ApplicationUserRole, IdentityUserLogin<string>, IdentityRoleClaim<string>, IdentityUserToken<string>>
    {
        ...
        public virtual DbSet<WalkIn_Appointment> tblWalkInApp { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder
               .Entity<WalkIn_Appointment>()
               .HasOne(a => a.Nurse)
               .WithMany(p => p.WalkInNurseAppointments)
               .HasForeignKey(a => a.NurseId)
               .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder
               .Entity<WalkIn_Appointment>()
               .HasOne(a => a.Doctor)
               .WithMany(p => p.WalkInDoctorAppointments)
               .HasForeignKey(a => a.DoctorId)
               .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<WalkIn_Appointment>(entity =>
            {
                entity.ToTable("tblWalkInApp");

                entity.HasKey(e => e.WalkInId_AppointmentId);

                entity.Property(e => e.WalkInId_AppointmentId).HasMaxLength(50)
                .HasDefaultValueSql("(newid())");
