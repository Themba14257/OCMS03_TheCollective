...
namespace OCMS03.Models
{
    public class ApplicationUser : IdentityUser
    {
        ...
        public List<WalkIn_Appointment> WalkInNurseAppointments { get; set; } = new List<WalkIn_Appointment>();
        public List<WalkIn_Appointment> WalkInDoctorAppointments { get; set; } = new List<WalkIn_Appointment>();
